    ...
    $.fn, {
        ...
        bitmapCutter: function (settings) {
            ...
            var ps = $.fn.extend({
                ...
                holderSize: { width: 622, height: 500 },
            ...
            var $newimg = $('<img class="jquery-bitmapcutter-newimg" alt="" src=""  style="display: none;/>')
                                        .appendTo($cr).hide();
                    ...
                    $.ajax({
                        ...
                        success: function (json) {
                            if (json.msg == 'success') {
                                ...
                                $info.show();
                                $processed.fadeOut();
                                $newimg.attr('src', json.src).show(); //xiugai
